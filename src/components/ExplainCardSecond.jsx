...
export const ExplainCardSecond = ({ image, head, text, name }) => {
  return (
    <div className="container md:flex justify-center shadow-md">
      <div className="md:w-1/2 flex flex-col gap-[24px] p-[48px] ">
      ...
      <div className="md:w-1/2 p-[48px] rounded-r-[12px] bg-[#F9FAFB] flex justify-center">
